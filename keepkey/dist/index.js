    ...
    return ({ device }) => {
        ...
        return {
            ...
            getInterface: async ({ EventEmitter, chains }) => {
                ...
                const { accountSelect, entryModal } = await import('@web3-onboard/hw-common');
                ...
                const keepKeyProvider = getHardwareWalletProvider(() => currentChain.rpcUrl);
